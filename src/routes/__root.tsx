...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Glass Maind" },
      { name: "description", content: "Glass Maind. Estratégia, identidade visual, design e experiências digitais para marcas com presença." },
      { name: "author", content: "Glass Maind" },
      { property: "og:title", content: "Glass Maind" },
      { property: "og:description", content: "Estratégia, identidade visual, design e experiências digitais para marcas com presença." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Glass Maind" },
      { name: "twitter:description", content: "Estratégia, identidade visual, design e experiências digitais para marcas com presença." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Inter:wght@200;300;400;500;600;700&family=Manrope:wght@300;400;500;600;700;800&display=swap" },
